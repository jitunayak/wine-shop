...
import { Container, HStack, Label, VStack } from "../src/components";
                    ...
                    <HStack>
                        <Container className="">
                            ...
                            {index !== deliveryTracker.length - 1 && (
                                <Container
                                    className={`w-1 h-12 ml-2 bg-${item.isCompleted ? "green" : "slate"
                                        }-600`}
                                />
                            )}
                        </Container>
                        <Container>
                            <Label
                                className={`mt-2 font-bold text-md text-${item.isCompleted ? "green" : "neutral"
                                    }-700`}
                            >
                                {item.name}
                            </Label>
